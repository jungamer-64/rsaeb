...
use crate::execution::{OwnedRuleAttemptSession, OwnedRunSession, RuleAttemptSession, RunSession};
...
impl Program {
    ...
    ) -> Result<RuleAttemptSession<'_>, RunError> {
        RuleAttemptSession::new(self, seed, limit)
    }
